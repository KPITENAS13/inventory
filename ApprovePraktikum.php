                                ...
                                <div class="module-body">
                                    ...
                                    <form class=form-horizontal row-fluid name=frm action=query/PraktikumApprove.php method=post>
                                        <div class=control-group>
                                            ...
                                            <div class=controls>
                                                <input type=text id=basicinput placeholder=$r[nama_praktikum] class=span2 disabled>
                                                <input type=hidden name=inputNama_praktikum value=$r[nama_praktikum] class=span2 >
                                            </div> </br>
                                            <label class=control-label for=basicinput>Periode</label>
                                            <div class=controls>
                                                <input type=text id=basicinput placeholder=$r[periode] class=span2 disabled>
                                                <input type=hidden name=inputPeriode value=$r[periode] class=span2 >
                                            </div>
                                        </div>
